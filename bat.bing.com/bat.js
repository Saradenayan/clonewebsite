function UET(o) {
    ...
    this.insightsGetCookie = function(n) {
        if (this.beaconParams.Ver < 2 || this.uetConfig.cookieAllowed === !1 || this.uetConfig.consent.adStorageAllowed === !1) return null;
    ...
    this.insightsSetCookie = function(n, t) {
        var f, e;
        if (!(this.beaconParams.Ver < 2) && this.uetConfig.cookieAllowed !== !1 && this.uetConfig.consent.adStorageAllowed !== !1 && this.stringExists(n) && !(n.length > this.insightsDataMaxLength)) {
